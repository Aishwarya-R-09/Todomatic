        ...
        <div className="container" style={{marginTop:"40px"}}>
            ...
            
            {
                ...
                <div className="buttons">
                    ...
                    <button className="button" id="btn2" onClick={()=>{props.deleteTask(props.id)}}>
                        <b>
                            Delete
                        </b>
                    </button>
...

            {
                editMode && 
                <div className="buttons">
                    <button id="btn1" className="button first" onClick={()=>{props.saveTask(props.id,newValue); changeEditMode(false);}}>
                        <b>
                            Save
                        </b>
                    </button>
                    <button id="btn2" className="button" onClick={()=>{ changeEditMode(false); changeNewValue(props.name)}}>
                        <b>
                            Cancel
                        </b>
                    </button>
